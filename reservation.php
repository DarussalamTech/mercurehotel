    ...
    <body>
    	...
    	<div class="inner_child_div footer">
            ...
            <div class="footer_box">
               ...
               <div class="image-row">
                                            <div class="image-set">
                                            <div class="footer_img_gallery"><a class="example-image-link" href="images/footer_img_gallery/image_a1.jpg" data-lightbox="example-set" >Click Here to View Gallery</a></div>
                                            </div>
                                                <a style="display:none" class="example-image-link" href="images/footer_img_gallery/image_a2.jpg" data-lightbox="example-set"></a>
                                                <a style="display:none" class="example-image-link" href="images/footer_img_gallery/image_a3.jpg" data-lightbox="example-set"></a>
                                                <a style="display:none" class="example-image-link" href="images/footer_img_gallery/image_a4.jpg" data-lightbox="example-set"></a>
                                                <a style="display:none" class="example-image-link" href="images/footer_img_gallery/image_a5.jpg" data-lightbox="example-set"></a>
                                                <a style="display:none" class="example-image-link" href="images/footer_img_gallery/image_a6.jpg" data-lightbox="example-set"></a>
                                                <a style="display:none" class="example-image-link" href="images/footer_img_gallery/image_a7.jpg" data-lightbox="example-set"></a>
                                                <a style="display:none" class="example-image-link" href="images/footer_img_gallery/image_1.jpg" data-lightbox="example-set"></a>
